...
def update_hand(hand, word):
    ...
    if word:
        ...
        for letter in hand:
            copy_hand[letter] = hand[letter] - word_freq.get(letter, 0)
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while True:
        ...
        display_hand(hand)
        # Ask user for input
        input_word = input("Enter word, or ""!!"" to indicate that you are finished: ").lower()
        ...
        # Otherwise (the input is not two exclamation points):
            ...
            if is_valid_word(input_word, hand, word_list):
                ...
                total_score += score
                print(f"'{input_word}'" "earned", score, "points. Total: ", total_score)
    ...
    if input_word == "!!" or calculate_handlen(hand) == 0:
        print("user entered '!!' or ran out of letters")
...
def substitute_hand(hand, letter):
    ...
    letter = letter.lower()
    copy_letter = letter
    while copy_letter in hand:
        if letter == '*':
            return hand
            break
        else:
            LETTERS = VOWELS + CONSONANTS
            copy_letter = random.choice(LETTERS)
            hand[copy_letter] = hand.get(letter, 0)
            del(hand[letter])
            return hand
